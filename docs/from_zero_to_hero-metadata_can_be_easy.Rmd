...
#  background-color: coral;
  background-image: url("fig/uzh_logo_e_pos.svg"), url("fig/qr_talk.svg"), url("https://zenodo.org/badge/DOI/10.5281/zenodo.3516739.svg");
...
* Domain Specific Metadata Schemes
...
We needed a schme to describe our data
---
...
# How to use <br/> a Domain Specific MetaData Scheme
...
background-image: url(./fig/sceptical-dog-cropped.jpg), url(./fig/sceptical-cat.jpg) 
background-size: 37%, 37%
background-position: 0% 100%, 100% 100%
.dt[ Image credit: [imgflip](https://imgflip.com/memetemplate/128802203/Sceptical-Cat) [fsmedia](https://fsmedia.imgix.net/bb/ae/c8/cf/ac4d/4437/817c/82a78283e799/the-popularity-of-cbd-products-isnt-validated-by-science----yet.jpeg) ]
...
background-image: url(./fig/ShinyApp-0.png)
background-size: 43%
...
background-image: url(./fig/ShinyApp-1.png)
background-size: 43%
background-position: 50% 25%
...
background-image: url(./fig/ShinyApp-2.png)
background-size: 43%
background-position: 50% 25%
...
background-image: url(./fig/ShinyApp-3.png)
background-size: 43%
background-position: 50% 25%
...
background-image: url(./fig/ShinyApp-4.png)
background-size: 43%
background-position: 50% 25%
...
background-image: url(./fig/ShinyApp-5.png)
background-size: 43%
background-position: 50% 25%
...
background-image: url(./fig/xml.png), url(./fig/xml.png)
...
background-image: url(./fig/happy-dog-cropped.jpg), url(./fig/happy-cat.jpg) 
...
background-image: url(./fig/frightened-dog.jpg), url(./fig/frightened-cat.jpg) 
background-size: 37%, 37%
background-position: 0% 100%, 100% 100%
.dt[ Image credit: [the conversation](https://theconversation.com/cat-muzzles-cruel-or-useful-118885) [the conversation](https://images.theconversation.com/files/143301/original/image-20161026-11265-1xnf3ye.jpg?ixlib=rb-1.1.0&q=45&auto=format&w=926&fit=clip) ]
...
background-image: url(./fig/terrified-cat.jpg)
background-size: contain
background-position: top center
.dt[ Image credit: [ask ideas](https://www.askideas.com/31-very-funny-scared-images-and-photos/)]
...
---
class: center, top
background-image: url(./fig/future-cat.gif)
background-size: 100%
background-position: 100% 100%
.dt[ Image credit: [gifer](https://gifer.com/en/80Y2)]

---
class: right, top
background-image: url(./fig/future-cat.png)
background-size: 50%
...
### Web Based Repository of schemes 
...
background-image: url(./fig/qr_talk_github.svg),url(./fig/qr_dmdScheme.svg),url(./fig/big_coffee.jpg),url("https://zenodo.org/badge/DOI/10.5281/zenodo.3516739.svg"),url("https://zenodo.org/badge/DOI/10.5281/zenodo.3229615.svg")
