...
#  background-color: coral;
  background-image: url("fig/uzh_logo_e_pos.svg"), url("fig/qr_talk.svg"), url("https://zenodo.org/badge/DOI/10.5281/zenodo.3516850.svg");
...
background-image: url(./fig/qr_talk_github.svg),url(./fig/qr_dmdScheme.svg),url(./fig/big_coffee.jpg),url("https://zenodo.org/badge/DOI/10.5281/zenodo.3516850.svg"),url("https://zenodo.org/badge/DOI/10.5281/zenodo.3229615.svg")
